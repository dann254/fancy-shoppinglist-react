  ...
  render() {
    return (
      ...
      <NavHome />
        ...
        <h4 className="an">Here is a solution that will make you enjoy your experience with shopping lists.<br /> It even allows you to share your lists.<br /> How amazing!</h4>
